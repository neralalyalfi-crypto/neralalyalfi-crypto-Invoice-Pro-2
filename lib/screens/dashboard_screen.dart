  ...
  @override Widget build(BuildContext context) => Scaffold(
    ...
    body: Padding(padding: const EdgeInsets.all(16), child: Column(
      ...
      children: [
        ...
        const SizedBox(height: 12),
        OutlinedButton.icon(icon: const Icon(Icons.people), label: const Text('Customers'),
          onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const CustomerScreen()))),
        const SizedBox(height: 12),
        OutlinedButton.icon(icon: const Icon(Icons.inventory_2), label: const Text('Products & Services'),
